...
public class MappingReader {
    ...
    public MappingReader(Reader reader) {
     ...
     *
     * @param mappingProcessor the given processor
     * @throws IOException if the mapping could not be processed
     */
    ...
    /**
     * Parses the given line with a class mapping and processes the results with the given mapping processor.
     *
     * @return the old class name, or null if any subsequent class member lines can be ignored.
     */
